...
Lab 3: parses variable declarations, assignments, expressions, and function definitions, while also integrating a symbol table for tracking variables and values. 
